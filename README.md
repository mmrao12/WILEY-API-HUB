# ALM_CreateUser OpenAPI Specification
[![Build Status](https://travis-ci.org/mmrao12/WILEY-API-HUB.svg?branch=master)](https://travis-ci.org/mmrao12/WILEY-API-HUB)
...
6. If you did everything correct, https://mmrao12.github.io/WILEY-API-HUB/ will lead to your new docs
...
- Documentation(ReDoc): https://mmrao12.github.io/WILEY-API-HUB/
- SwaggerUI: https://mmrao12.github.io/WILEY-API-HUB/swagger-ui/
- Look full spec:
    + JSON https://mmrao12.github.io/WILEY-API-HUB/swagger.json
    + YAML https://mmrao12.github.io/WILEY-API-HUB/swagger.yaml
- Preview spec version for branch `[branch]`: https://mmrao12.github.io/WILEY-API-HUB/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mmrao12.github.io/WILEY-API-HUB/ with url from the message: `Server started <url>`
